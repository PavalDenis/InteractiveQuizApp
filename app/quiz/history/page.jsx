...
const historyQuiz = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        ...
        const savedQuestions = JSON.parse(localStorage.getItem('customQuestionsHist')) || [];
        setQuestionsData([...data.Istorie, ...savedQuestions]);
      } catch (error) {
  ...
  const handleAddQuestion = () => {
    ...
    localStorage.setItem('customQuestionsHist', JSON.stringify(savedQuestions));
