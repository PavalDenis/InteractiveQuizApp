...
const GeneralKnowledgeQuiz = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        ...
        const savedQuestions = JSON.parse(localStorage.getItem('customQuestionsGeneral')) || [];
        setQuestionsData([...data.CulturaGenerala, ...savedQuestions]);
      } catch (error) {
  ...
  const handleAddQuestion = () => {
    ...
    localStorage.setItem('customQuestionsGeneral', JSON.stringify(savedQuestions));
